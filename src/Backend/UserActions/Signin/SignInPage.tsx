          ...
          <div className="mt-6 sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <p className="mt-2 text-center text-sm text-gray-600">
              ...
              <div>
                <button
                  // type="submit"
                  className="flex w-full justify-center rounded-md bg-blue-600 hover:bg-blue-700 px-3 py-2 text-white font-semibold"
                ...
                <div className="mt-6">
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-sm">
                      <span className="px-2 text-black-500 font-bold">
                        Or continue with
                      </span>
                    </div>
                  </div>
