...
const AskAi = () => {
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      >
        <div className="bg-gray-500 bg-opacity-30 text-white p-3 md:p-5 rounded-lg shadow-lg mx-auto mt-10 text-center max-w-xl">
          <h1 className="text-2xl text-orange-400 md:text-4xl">How can we help, {user?.twitterUsername || user?.displayName || user?.email}?</h1>
