...
const Search = () => {
  ...
  // State variable to track if the user has clicked without searching
  ...
  const handleUserClick = () => {
    // Set hasClicked to true when user clicks anywhere on the page
    setHasClicked(true);
  };
  ...
  return (
    <div
      ...
      className={`${!searchResults.results.results.length && hasClicked ? "bg-green-100" : ""
        }`}
    >
      <NavBar />
