            ...
            { !submitted ? (
                <form onSubmit={handleSubmit}>
                            ...
                            <div className="col-span-full sm:col-span-6">
                                ...
                                <div className="mt-2 flex items-center gap-x-3">
                                    ...
                                    <input
                                        ...
                                        className="rounded-md bg-white px-2.5 py-2 w-3/4 md:w-1/4 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
                                    />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="mt-6 flex items-center justify-end gap-x-4">
                        ...
                        <button
                            type="submit"
                            className="rounded-md bg-gradient-to-r from-indigo-500 to-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-md hover:bg-gradient-to-r hover:from-indigo-400 hover:to-indigo-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 transition duration-200 ease-in-out"
                        >
                            Save
                        </button>
                    </div>
