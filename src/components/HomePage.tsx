...
<form onSubmit={handleSearch} className="mb-4">
  ...
  <div className="flex flex-col items-center space-y-4 md:space-y-0 md:flex-row md:items-start">
    <input
      type="search"
      placeholder="Search here"
      className="border border-gray-400 rounded-lg px-3 py-2 w-full md:w-[480px] focus:outline-none text-black mb-4 md:mb-0"
      onChange={e => setSearchInput(e.target.value)}
      value={searchInput}
    />
    <div className="flex flex-col space-y-2 md:space-y-0 md:flex-row md:w-[480px] md:space-x-2">
      <input
        type="date"
